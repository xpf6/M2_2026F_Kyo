...
\subsection{C12880MA駆動における「フライングスタート」問題} 
...
\subsection{FSM（有限状態機械，以下，FSM）の設計}
...
\subsection{FSM（有限状態機械）による制御フロー}
...
\subsection{STM32H723ZGでの\SI{5}{\mega\hertz}高速取得の実現}
